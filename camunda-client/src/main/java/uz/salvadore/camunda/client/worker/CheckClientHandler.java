...
@ExternalTaskSubscription(
  topicName = CamundaTopics.CHECK_CLIENT,
  lockDuration = 60000,
...
public class CheckClientHandler implements ExternalTaskHandler {
  ...
  public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
    try {
      ...
      customerService.checkClient(appId);
