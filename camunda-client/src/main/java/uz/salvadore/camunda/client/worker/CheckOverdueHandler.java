...
@ExternalTaskSubscription(
  topicName = CamundaTopics.CHECK_OVERDUE,
  lockDuration = 60000,
...
public class CheckOverdueHandler implements ExternalTaskHandler {
  ...
  public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
    try {
      ...
      customerService.checkOverdue(appId);
